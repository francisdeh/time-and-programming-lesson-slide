...
import {
  ...
  setDiagramTitle,
  utils
} from "./chunk-ETLYEO47.js";
import "./chunk-WXLMTRIV.js";

// node_modules/mermaid/dist/sequenceDiagram-62b9e65a.js
var parser = function() {
...
var addActorRenderingData = function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  let prevWidth = 0;
  let prevMargin = 0;
  let prevBox = void 0;
  let maxHeight = 0;
...
var drawActors = function(diagram2, actors, actorKeys, isFooter) {
  if (!isFooter) {
    for (const actorKey of actorKeys) {
      const actor = actors[actorKey];
...
var buildNoteModel = function(msg, actors, diagObj) {
...
var calculateLoopBounds = function(messages, actors, _maxWidthPerActor, diagObj) {
  const loops = {};
  const stack = [];
...
//# sourceMappingURL=sequenceDiagram-62b9e65a-TM6OJPFW.js.map
