...
// node_modules/mermaid/dist/sankeyDiagram-fd560d01.js
function Tt(t) {
...
` + o + "^";
      ...
      next: function() {
        ...
        return o ? (s = this.test_match(o, b[_]), s !== false ? s : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
function Yt() {
  ...
  function E({ nodes: e, links: f }) {
    ...
    const l = new Map(e.map((h2, r) => [m(h2, r, e), h2]));
...
${x}${Math.round(w * 100) / 100}${E}` : g;
  ...
  $.append("path").attr("d", se()).attr("stroke", I).attr("stroke-width", (g) => Math.max(1, g.width)), b_(void 0, o, 0, b);
};
var ae = {
  draw: oe
};
...
//# sourceMappingURL=sankeyDiagram-fd560d01-4SKXE3UM.js.map
