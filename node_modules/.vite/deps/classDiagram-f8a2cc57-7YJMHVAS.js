...
// node_modules/mermaid/dist/classDiagram-f8a2cc57.js
var _ = 0;
var $ = function(i, a, t, o, p) {
  ...
  const s = a.points, c = P().x(function(e) {
    ...
    return e.y;
  }).curve(qf), n = i.append("path").attr("d", c(s)).attr("id", "edge" + _).attr("class", "relation");
  let r = "";
  ...
  let k = Ze.calcLabelPosition(a.points);
  f = k.x, h = k.y;
  let y, m, w, b;
  if (x % 2 !== 0 && x > 1) {
    let e = Ze.calcCardinalityPosition(
      t.relation.type1 !== "none",
      a.points,
      a.points[0]
    ), d = Ze.calcCardinalityPosition(
...
//# sourceMappingURL=classDiagram-f8a2cc57-7YJMHVAS.js.map
