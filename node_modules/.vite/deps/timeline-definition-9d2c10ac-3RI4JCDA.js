...
// node_modules/mermaid/dist/timeline-definition-9d2c10ac.js
var K = function() {
...
var it = () => M_;
var rt = function() {
  Q.length = 0, G.length = 0, R = "", V.length = 0, v_();
};
var at = function(n) {
  R = n, Q.push(n);
};
...
var Rt = function(n, t, e, a) {
  ...
  A.debug("bounds", F), v && u.append("text").text(v).attr("x", F.width / 2 - c).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), h = x ? i + r + 150 : r + 100, u.append("g").attr("class", "lineWrapper").append("line").attr("x1", c).attr("y1", h).attr("x2", F.width + 3 * c).attr("y2", h).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), b_(
    void 0,
    u,
...
var Wt = (n) => {
  ...
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
    n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], ui(n["lineColor" + e]) ? n["lineColor" + e] = B(n["lineColor" + e], 20) : n["lineColor" + e] = L(n["lineColor" + e], 20);
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
    const a = "" + (17 - 3 * e);
    t += `
...
//# sourceMappingURL=timeline-definition-9d2c10ac-3RI4JCDA.js.map
