...
var Ie = ei;
var ti = (t8) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t8);
function ri(t8) {
...
var dt = Xr;
function L(t8) {
  return re(t8), { type: ue, contents: t8 };
}
function Jr(t8, e) {
  return re(e), { type: le, contents: e, n: t8 };
}
function E(t8, e = {}) {
  return re(t8), dt(e.expandedStates, true), { type: te, id: e.id, contents: t8, break: !!e.shouldBreak, expandedStates: e.expandedStates };
}
function Zr(t8) {
...
function Ct(t8) {
  return dt(t8), { type: ce, parts: t8 };
}
function me(t8, e = "", r = {}) {
  return re(t8), e !== "" && re(e), { type: pe, breakContents: t8, flatContents: e, groupId: r.groupId };
}
function tn(t8, e) {
  return re(t8), { type: he, contents: t8, groupId: e.groupId, negate: e.negate };
}
var ne = { type: fe };
var ni = { type: Y, hard: true };
var si = { type: Y, hard: true, literal: true };
var A = { type: Y };
var v = { type: Y, soft: true };
var S = [ni, ne];
var rn = [si, ne];
function M(t8, e) {
  re(t8), dt(e);
...
function mi(t8, e, r, n) {
  ...
  return /^\s*$/.test(i) ? "" : x(i, t8, { parser: "__ng_directive", __isInHtmlAttribute: false, trailingComma: "none" }, j);
}
var hn = mi;
...
function fn(t8, e) {
  ...
  return t8.find(({ filenames: n }) => n == null ? void 0 : n.some((s) => s.toLowerCase() === r)) ?? t8.find(({ extensions: n }) => n == null ? void 0 : n.some((s) => r.endsWith(s)));
}
function di(t8, e) {
  if (e)
...
async function Nn(t8, e) {
  ...
  for (let [n, s] of t8.split(hr).entries())
    if (n % 2 === 0)
      ...
      try {
        r.push(E(["{{", L([A, await x(s, e, { parser: "__ng_interpolation", __isInHtmlInterpolation: true, trailingComma: "none" })]), A, "}}"]));
      } catch {
        r.push("{{", T(s), "}}");
      }
  return r;
...
var Ii = fr({ parser: "__ng_binding" });
var Ri = fr({ parser: "__ng_directive" });
function $i(t8, e) {
  if (e.parser !== "angular")
    return;
...
function Wi(t8) {
  ...
  function g() {
    ...
    for (B = 0; B < n.length; B++)
      d = n[B], y = d[d.length - 1], O = d.substring(0, d.length - 1), b = parseInt(O, 10), V = parseFloat(O), On.test(O) && y === "w" ? ((_ || D) && (C = true), b === 0 ? C = true : _ = b) : Ui.test(O) && y === "x" ? ((_ || D || I) && (C = true), V < 0 ? C = true : D = V) : On.test(O) && y === "h" ? ((I || D) && (C = true), b === 0 ? C = true : I = b) : C = true;
    if (!C)
...
function Un(t8, e, r) {
  let { node: n } = r, s = P(n);
  return x(`type T<${s}> = any`, t8, { parser: "babel-ts", __isEmbeddedTypescriptGenericParameters: true }, j);
}
...
function ea(t8) {
  return async (e, r, n, s) => {
    ...
    if (i)
      return i = St(i, (a) => typeof a == "string" ? w(false, a, '"', "&quot;") : a), [n.node.rawName, '="', E(i), '"'];
  };
}
var Kn = Zi;
var Qn = new Proxy(() => {
...
function ia(t8, e, r) {
  ...
  let s = ((m = n.prev) == null ? void 0 : m.type) === "comment" && sa(n.prev.value), i = typeof s == "boolean" ? () => s : Array.isArray(s) ? (g) => s.includes(g.rawName) : () => false, a = t8.map(({ node: g }) => i(g) ? T(e.originalText.slice(se(g), ie(g))) : r(), "attrs"), o = n.type === "element" && n.fullName === "script" && n.attrs.length === 1 && n.attrs[0].fullName === "src" && n.children.length === 0, p = e.singleAttributePerLine && n.attrs.length > 1 && !_e(n, e) ? S : A, l = [L([o ? " " : A, M(p, a)])];
    ...
    case "element":
      ...
      if (!r.isSelfClosing && vt(r, e)) {
        ...
        return n ? async (s, i) => {
          ...
          return o || (u = await s(ar(a), { parser: n, __embeddedInHtml: true }), o = u === ""), [z(r, e), E(rt(t8, e, i)), o ? "" : S, u, o ? "" : S, Ze(r, e), W(r, e)];
        } : void 0;
      }
      break;
    case "text":
...
function as(t8, e, r) {
  ...
  let i = os(n);
  return n.children.length > 0 ? (n.firstChild.hasLeadingSpaces = true, n.lastChild.hasTrailingSpaces = true, s.push(L([S, qe(t8, e, r)])), i && s.push(S, "}")) : i && s.push("}"), E(s, { shouldBreak: true });
}
function os(t8) {
  var e, r;
...
var Ba = { preprocess: gs, print: ka, insertPragma: ns, massageAstNode: cn, embed: Jn, getVisitorKeys: ts };
var ds = Ba;
...
var Ar = { bracketSpacing: { category: "Common", type: "boolean", default: true, description: "Print spaces between brackets.", oppositeDescription: "Do not print spaces between brackets." }, singleQuote: { category: "Common", type: "boolean", default: false, description: "Use single quotes instead of double quotes." }, proseWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap prose.", choices: [{ value: "always", description: "Wrap prose if it exceeds the print width." }, { value: "never", description: "Do not wrap prose." }, { value: "preserve", description: "Wrap prose as-is." }] }, bracketSameLine: { category: "Common", type: "boolean", default: false, description: "Put > of opening tags on the last line instead of on a new line." }, singleAttributePerLine: { category: "Common", type: "boolean", default: false, description: "Enforce single attribute per line in HTML, Vue and JSX." } };
var Ss = "HTML";
var La = { bracketSameLine: Ar.bracketSameLine, htmlWhitespaceSensitivity: { category: Ss, type: "choice", default: "css", description: "How to handle whitespaces in HTML.", choices: [{ value: "css", description: "Respect the default value of CSS display property." }, { value: "strict", description: "Whitespaces are considered sensitive." }, { value: "ignore", description: "Whitespaces are considered insensitive." }] }, singleAttributePerLine: Ar.singleAttributePerLine, vueIndentScriptAndStyle: { category: Ss, type: "boolean", default: false, description: "Indent script and style tags in Vue files." } };
var _s = La;
var Vr = {};
...
function Ao(t8, e, r) {
  ...
  return { type: "ieConditionalComment", complete: p, children: l, condition: w(false, s.trim(), /\s+/g, " "), sourceSpan: t8.sourceSpan, startSourceSpan: new f(t8.sourceSpan.start, o), endSourceSpan: new f(u, t8.sourceSpan.end) };
}
function Do(t8, e, r) {
  let [, n] = r;
  return { type: "ieConditionalStartComment", condition: w(false, n.trim(), /\s+/g, " "), sourceSpan: t8.sourceSpan };
}
function vo(t8) {
...
function yo(t8) {
  if (t8.type === "block") {
    ...
    t8.parameters = { type: "angularControlFlowBlockParameters", children: t8.parameters, sourceSpan: new f(t8.parameters[0].sourceSpan.start, X(false, t8.parameters, -1).sourceSpan.end) };
  }
}
function wo(t8) {
...
function js(t8, e, r) {
  let { name: n, canSelfClose: s = true, normalizeTagName: i = false, normalizeAttributeName: a = false, allowHtmComponentClosingTags: o = false, isTagNameCaseSensitive: u = false, shouldParseAsRawText: p } = e, { rootNodes: l, errors: m } = Hr(t8, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u, getTagContentType: p ? (...c) => p(...c) ? N.RAW_TEXT : void 0 : void 0, tokenizeAngularBlocks: n === "angular" ? true : void 0 });
  if (n === "vue") {
...
function Ks(t8, e, r = {}, n = true) {
  ...
  let l = new Zt(p), m = (g, C) => {
    let { offset: _ } = C, D = w(false, t8.slice(0, _), /[^\n\r]/g, " "), B = Ks(D + g, e, r, false);
...
var To = tr(Qs);
var xo = tr({ name: "angular" });
var ko = tr({ name: "vue", isTagNameCaseSensitive: true, shouldParseAsRawText(t8, e, r, n) {
  return t8.toLowerCase() !== "html" && !r && (t8 !== "template" || n.some(({ name: s, value: i }) => s === "lang" && i !== "html" && i !== "" && i !== void 0));
} });
var Bo = tr({ name: "lwc", canSelfClose: false });
var Lo = { html: ds };
var xh = Ur;
export {
  xh as default,
