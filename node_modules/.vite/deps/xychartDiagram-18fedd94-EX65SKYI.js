...
// node_modules/mermaid/dist/xychartDiagram-18fedd94.js
function Jt(e, t2, i) {
...
function Ai() {
  ...
  return y.title = E_(), ci.build(Y, y, H, Tt);
}
function wi() {
  return H;
}
...
var Ci = function() {
  v_(), X = 0, Y = Pt(), y = Lt(), H = Dt(), at = H.plotColorPalette.split(",").map((e) => e.trim()), G = false, rt = false;
};
var _i = {
  getDrawableElem: Ai,
  clear: Ci,
...
` + e);
  const _ = P_(t2), A2 = _.append("g").attr("class", "main"), m = A2.append("rect").attr("width", c.width).attr("height", c.height).attr("class", "background");
...
//# sourceMappingURL=xychartDiagram-18fedd94-EX65SKYI.js.map
