...
var Xe = class {
  ...
  getDisplayDetails() {
    let i = this.visibility + p1(this.id);
    this.memberType === "method" && (i += `(${p1(this.parameters.trim())})`, this.returnType && (i += " : " + p1(this.returnType))), i = i.trim();
  ...
  parseMember(i) {
    ...
    if (this.memberType === "method") {
      ...
      if (o) {
        const A2 = o[1] ? o[1].trim() : "";
        if (Qe.includes(A2) && (this.visibility = A2), this.id = o[2].trim(), this.parameters = o[3] ? o[3].trim() : "", r = o[4] ? o[4].trim() : "", this.returnType = o[5] ? o[5].trim() : "", r === "") {
      ...
      const l = i.length, o = i.substring(0, 1), A2 = i.substring(l - 1);
      Qe.includes(o) && (this.visibility = o), A2.match(/[$*]/) && (r = A2), this.id = i.substring(
        this.visibility === "" ? 0 : 1,
        r === "" ? l : l - 1
      );
    }
...
var we = 0;
var K = [];
var V = (e) => In.sanitizeText(e, Xn());
var w = function(e) {
  const i = In.sanitizeText(e, Xn());
  let r = "", l = i;
  if (i.indexOf("~") > 0) {
    const o = i.split("~");
    l = V(o[0]), r = V(o[1]);
...
var Ae = function(e) {
  const i = In.sanitizeText(e, Xn()), { className: r, type: l } = w(i);
  if (Object.hasOwn(p, r))
    return;
  const o = In.sanitizeText(r, Xn());
  p[o] = {
    id: o,
    type: l,
    label: o,
...
var dt = function() {
  Pe = [], p = {}, he = [], K = [], K.push(Ze2), O = {}, we = 0, v_();
};
var Et = function(e) {
  return p[e];
};
...
var gt = function(e) {
  A.debug("Adding relation: " + JSON.stringify(e)), Ae(e.id1), Ae(e.id2), e.id1 = w(e.id1).className, e.id2 = w(e.id2).className, e.relationTitle1 = In.sanitizeText(e.relationTitle1.trim(), Xn()), e.relationTitle2 = In.sanitizeText(e.relationTitle2.trim(), Xn()), Pe.push(e);
};
var kt = function(e, i) {
...
var _t = function(e, i, r) {
  ...
  e.split(",").forEach(function(o) {
    let A2 = o;
    o[0].match(/\d/) && (A2 = pe + A2), p[A2] !== void 0 && (p[A2].link = Ze.formatUrl(i, l), l.securityLevel === "sandbox" ? p[A2].linkTarget = "_top" : typeof r == "string" ? p[A2].linkTarget = V(r) : p[A2].linkTarget = "_blank");
  }), Me(e, "clickable");
};
...
var Nt = function(e, i, r) {
  const l = In.sanitizeText(e, Xn());
  if (Xn().securityLevel !== "loose" || i === void 0)
    return;
  const A2 = l;
  if (p[A2] !== void 0) {
    const g = qe(A2);
...
var Ze2 = function(e) {
  let i = Ct(".mermaidTooltip");
  (i._groups || i)[0][0] === null && (i = Ct("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), Ct(e).select("svg").selectAll("g.node").on("mouseover", function() {
    const o = Ct(this);
    ...
    i.transition().duration(500).style("opacity", 0), Ct(this).classed("hover", false);
  });
};
K.push(Ze2);
var $e = "TB";
...
//# sourceMappingURL=chunk-MGJBKSQE.js.map
