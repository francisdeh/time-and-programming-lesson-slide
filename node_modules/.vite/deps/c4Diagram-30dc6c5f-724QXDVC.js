...
// node_modules/mermaid/dist/c4Diagram-30dc6c5f.js
var Yt = function() {
...
function I(e, t, r, o, l) {
  if (!t[e].width)
    if (r)
      t[e].text = M0(t[e].text, l, o), t[e].textLines = t[e].text.split(In.lineBreakRegex).length, t[e].width = l, t[e].height = $0(t[e].text, o);
    else {
      ...
      for (const s of n)
        t[e].width = Math.max(
          Qi(s, o),
          t[e].width
        ), a = $0(s, o), t[e].height = t[e].height + a;
    }
}
...
//# sourceMappingURL=c4Diagram-30dc6c5f-724QXDVC.js.map
