import {
  Ur
} from "./chunk-FKPS56HU.js";
import {
  P
} from "./chunk-7M4PX3EN.js";
import {
  A,
  Ct,
  P0,
...
// node_modules/mermaid/dist/edges-13d9e871.js
var ht = (a, t, r, i) => {
  t.forEach((e) => {
    bt[e](a, r, i);
  });
...
function kt(a) {
  const t = Ct(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), r = t.append("xhtml:div"), i = a.label, e = a.isNode ? "nodeLabel" : "edgeLabel";
  return r.html(
...
var B = async (a, t, r, i) => {
  let e;
  const s = t.useHtmlLabels || ka(Xn().flowchart.htmlLabels);
  ...
  const o = l.node();
  let h;
  t.labelType === "markdown" ? h = Ur(l, ri(P0(c), Xn()), {
    useHtmlLabels: s,
  ...
  if (ka(Xn().flowchart.htmlLabels)) {
    const p = h.children[0], x = Ct(h), m = p.getElementsByTagName("img");
    if (m) {
          ...
          (u) => new Promise((S) => {
            function T() {
              if (u.style.display = "flex", u.style.flexDirection = "column", g) {
                const C = Xn().fontSize ? Xn().fontSize : window.getComputedStyle(document.body).fontSize, O = 5, j = parseInt(C, 10) * O + "px";
...
var _t = Ct2;
var K = (a) => a ? " " + a : "";
var $ = (a, t) => `${t || "node default"}${K(a.classes)} ${K(
  a.class
)}`;
var G = async (a, t) => {
  ...
  return c.attr("style", t.style), v(t, c), t.intersect = function(o) {
    return A.warn("Intersect called"), b.polygon(t, l, o);
  }, r;
};
var $t = (a, t) => {
...
var Ht = async (a, t) => {
  const { shapeSvg: r, bbox: i } = await B(a, t, $(t), true), e = i.width + t.padding, s = i.height + t.padding, n = [
    { x: -2 * s / 6, y: 0 },
    { x: e - s / 6, y: 0 },
    { x: e + 2 * s / 6, y: -s },
    { x: s / 6, y: -s }
...
function it(a, t, r, i) {
  ...
  t.includes("t") ? (A.debug("add top border"), s(r)) : n(r), t.includes("r") ? (A.debug("add right border"), s(i)) : n(i), t.includes("b") ? (A.debug("add bottom border"), s(r)) : n(r), t.includes("l") ? (A.debug("add left border"), s(i)) : n(i), a.attr("stroke-dasharray", e.join(" "));
}
var At = (a, t) => {
  let r;
  ...
  const o = n.node().appendChild(R(c, t.labelStyle, true, true));
  let h = { width: 0, height: 0 };
  if (ka(Xn().flowchart.htmlLabels)) {
    const m = o.children[0], g = Ct(o);
...
var zt = async (a, t) => {
  ...
  return s.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", i.width / 2 + e).attr("width", i.width + t.padding).attr("height", i.height + t.padding), A.info("Circle main"), v(t, s), t.intersect = function(n) {
    return A.info("Circle intersect", t, i.width / 2 + e, n), b.circle(t, i.width / 2 + e, n);
  }, r;
};
var Zt = async (a, t) => {
  const { shapeSvg: r, bbox: i, halfPadding: e } = await B(
  ...
  return n.attr("class", t.class), l.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", i.width / 2 + e + s).attr("width", i.width + t.padding + s * 2).attr("height", i.height + t.padding + s * 2), c.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", i.width / 2 + e).attr("width", i.width + t.padding).attr("height", i.height + t.padding), A.info("DoubleCircle main"), v(t, l), t.intersect = function(o) {
    return A.info("DoubleCircle intersect", t, i.width / 2 + e + s, o), b.circle(t, i.width / 2 + e + s, o);
  }, r;
};
var Ft = async (a, t) => {
  const { shapeSvg: r, bbox: i } = await B(
...
var Jt = (a, t) => {
  ...
  let p = 0;
  const x = t.classData.annotations && t.classData.annotations[0], m = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", g = d.node().appendChild(R(m, t.labelStyle, true, true));
  let u = g.getBBox();
  if (ka(Xn().flowchart.htmlLabels)) {
  ...
  t.classData.type !== void 0 && t.classData.type !== "" && (Xn().flowchart.htmlLabels ? S += "&lt;" + t.classData.type + "&gt;" : S += "<" + t.classData.type + ">");
  const T = d.node().appendChild(R(S, t.labelStyle, true, true));
  Ct(T).attr("class", "classTitle");
  let C = T.getBBox();
  if (ka(Xn().flowchart.htmlLabels)) {
    const k = T.children[0], L = Ct(T);
  ...
  t.classData.members.forEach((k) => {
    ...
    let W = L.displayText;
    Xn().flowchart.htmlLabels && (W = W.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
...
var ir = async (a, t, r) => {
  ...
  if (t.link) {
    let s;
    Xn().securityLevel === "sandbox" ? s = "_top" : t.linkTarget && (s = t.linkTarget || "_blank"), i = a.insert("svg:a").attr("xlink:href", t.link).attr("target", s), e = await tt[t.shape](i, t, r);
  } else
...
var or = (a, t) => {
  const r = ka(Xn().flowchart.htmlLabels), i = t.labelType === "markdown" ? Ur(a, t.label, {
    style: t.labelStyle,
    useHtmlLabels: r,
...
var fr = (a, t) => {
  A.info("Moving label abc78 ", a.id, a.label, F[a.id]);
  let r = t.updatedPath ? t.updatedPath : t.originalPath;
  if (a.label) {
    const i = F[a.id];
    let e = a.x, s = a.y;
    if (r) {
      const n = Ze.calcLabelPosition(r);
      A.info(
  ...
  if (a.startLabelLeft) {
    ...
    let e = a.x, s = a.y;
    if (r) {
      const n = Ze.calcTerminalLabelPosition(a.arrowTypeStart ? 10 : 0, "start_left", r);
      e = n.x, s = n.y;
    }
    i.attr("transform", "translate(" + e + ", " + s + ")");
  }
  if (a.startLabelRight) {
    ...
    let e = a.x, s = a.y;
    if (r) {
      const n = Ze.calcTerminalLabelPosition(
  ...
  if (a.endLabelLeft) {
    ...
    let e = a.x, s = a.y;
    if (r) {
      const n = Ze.calcTerminalLabelPosition(a.arrowTypeEnd ? 10 : 0, "end_left", r);
      e = n.x, s = n.y;
    }
    i.attr("transform", "translate(" + e + ", " + s + ")");
  }
  if (a.endLabelRight) {
    ...
    let e = a.x, s = a.y;
    if (r) {
      const n = Ze.calcTerminalLabelPosition(a.arrowTypeEnd ? 10 : 0, "end_right", r);
      e = n.x, s = n.y;
    }
    i.attr("transform", "translate(" + e + ", " + s + ")");
  }
...
var at = (a, t) => {
  ...
  let r = [], i = a[0], e = false;
  return a.forEach((s) => {
    if (A.info("abc88 checking point", s, t), !Pt(t, s) && !e) {
      const n = tr(t, i, s);
      A.warn("abc88 inside", s, i, n), A.warn("abc88 intersection", n);
      let l = false;
      r.forEach((c) => {
        l = l || c.x === n.x && c.y === n.y;
      }), r.some((c) => c.x === n.x && c.y === n.y) ? A.warn("abc88 no intersect", n, r) : r.push(n), e = true;
    } else
      A.warn("abc88 outside", s, i), i = s, e || r.push(s);
  }), A.warn("abc88 returning points", r), r;
};
var pr = function(a, t, r, i, e, s, n) {
  ...
  ), l.push(h.intersect(l[l.length - 1]))), r.toCluster && (A.info("to cluster abc88", i[r.toCluster]), l = at(r.points, i[r.toCluster].node), c = true), r.fromCluster && (A.info("from cluster abc88", i[r.fromCluster]), l = at(l.reverse(), i[r.fromCluster].node).reverse(), c = true);
  const f = l.filter((C) => !Number.isNaN(C.y));
  let d = qf;
  r.curve && (e === "graph" || e === "flowchart") && (d = r.curve);
  const { x: p, y: x } = qt(r), m = P().x(p).y(x).curve(d);
  let g;
  switch (r.thickness) {
    case "normal":
  ...
  let S = "";
  (Xn().flowchart.arrowMarkerAbsolute || Xn().state.arrowMarkerAbsolute) && (S = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, S = S.replace(/\(/g, "\\("), S = S.replace(/\)/g, "\\)")), A.info("arrowTypeStart", r.arrowTypeStart), A.info("arrowTypeEnd", r.arrowTypeEnd), Kt(u, r, S, n, e);
  let T = {};
...
//# sourceMappingURL=chunk-SFCKQXH6.js.map
