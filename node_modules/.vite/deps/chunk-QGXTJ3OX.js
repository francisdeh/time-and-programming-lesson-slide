...
// node_modules/mermaid/dist/index-5e9361c0.js
var Q = 4;
function Z(e) {
  return tn(e, Q);
}
...
var it = (e, t) => {
  ...
  e.nodes().forEach(function(n) {
    e.children(n).length > 0 && (A.warn(
      ...
      v2(n, e)
    ), g[n] = p(n, e), f[n] = { id: v2(n, e), clusterData: e.node(n) });
  }), e.nodes().forEach(function(n) {
...
var P = (e, t) => {
  ...
  for (const s of n)
    ...
    e.children(s) && e.children(s).length > 0) {
      ...
      A.warn("Old graph before copy", x(e)), R2(s, e, l, s), e.setNode(s, {
        clusterNode: true,
        id: s,
...
var rt = (e, t) => {
  ...
  const n = e.insert("g").attr("class", "cluster" + (t.class ? " " + t.class : "")).attr("id", t.id), r = n.insert("rect", ":first-child"), s = ka(Xn().flowchart.htmlLabels), c = n.insert("g").attr("class", "cluster-label"), d = t.labelType === "markdown" ? Ur(c, t.labelText, { style: t.labelStyle, useHtmlLabels: s }) : c.node().appendChild(R(t.labelText, t.labelStyle, void 0, true));
  let l = d.getBBox();
...
var ct = (e, t) => {
  const n = e.insert("g").attr("class", t.classes).attr("id", t.id), r = n.insert("rect", ":first-child"), s = n.insert("g").attr("class", "cluster-label"), c = n.append("rect"), d = s.node().appendChild(R(t.labelText, t.labelStyle, void 0, true));
  let l = d.getBBox();
  if (ka(Xn().flowchart.htmlLabels)) {
    const a = d.children[0], o = Ct(d);
    l = a.getBoundingClientRect(), o.attr("width", l.width), o.attr("height", l.height);
...
var j = async (e, t, n, r, s) => {
  ...
  await Promise.all(
    t.nodes().map(async function(a) {
      ...
      if (A.info("(Insert) Node XXX" + a + ": " + JSON.stringify(t.node(a))), o && o.clusterNode) {
        ...
        v(o, B), o.diff = y2.diff || 0, A.info("Node bounds (abc123)", a, o, o.width, o.x, o.y), nr(B, o), A.warn("Recursive render complete ", B, o);
      } else
        t.children(a).length > 0 ? (A.info("Cluster - the non recursive path XXX", a, o.id, o, t), A.info(v2(o.id, t)), f[o.id] = { id: v2(o.id, t), node: o }) : (A.info("Node - the non recursive path", a, o.id, o), await ir(w, t.node(a), c));
    })
  ), t.edges().forEach(function(a) {
    const o = t.edge(a.v, a.w, a.name);
    A.info("Edge " + a.v + " -> " + a.w + ": " + JSON.stringify(a)), A.info("Edge " + a.v + " -> " + a.w + ": ", a, " ", JSON.stringify(t.edge(a))), A.info("Fix", f, "ids:", a.v, a.w, "Translateing: ", f[a.v], f[a.w]), or(h, o);
  }), t.edges().forEach(function(a) {
  ...
  return st(t).forEach(function(a) {
    ...
    A.info("Position " + a + ": " + JSON.stringify(t.node(a))), A.info(
      ...
      " height: ",
      o.height
    ), o && o.clusterNode ? cr(o) : t.children(a).length > 0 ? (ft(l, o), f[o.id].node = o) : cr(o);
  }), t.edges().forEach(function(a) {
    const o = t.edge(a);
    A.info("Edge " + a.v + " -> " + a.w + ": " + JSON.stringify(o), o);
    const y2 = pr(u, a, o, f, n, t, r);
    fr(o, y2);
...
var xt = async (e, t, n, r, s) => {
  sr(e, n, r, s), lr(), hr(), dt(), et(), A.warn("Graph at first:", JSON.stringify(x(t))), it(t), A.warn("Graph after:", JSON.stringify(x(t))), await j(e, t, r, s);
};

export {
  xt
};
//# sourceMappingURL=chunk-QGXTJ3OX.js.map
