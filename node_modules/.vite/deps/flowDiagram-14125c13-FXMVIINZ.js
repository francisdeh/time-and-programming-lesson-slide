import {
  ...
  we,
  ye
} from "./chunk-XUSMAUVE.js";
import "./chunk-QGXTJ3OX.js";
import {
  Xe,
  je
} from "./chunk-6P4FFAPO.js";
import "./chunk-SFCKQXH6.js";
import "./chunk-FKPS56HU.js";
import {
  D,
  L,
  Un,
...
// node_modules/mermaid/dist/flowDiagram-14125c13.js
function Dt(r) {
  if (!r.ok)
...
var kt = function(r, e, t) {
  ...
  r.forEach(function(i) {
    ...
    l.style = v, l.labelStyle = h, i.interpolate !== void 0 ? l.curve = C0(i.interpolate, Nf) : r.defaultInterpolate !== void 0 ? l.curve = C0(r.defaultInterpolate, Nf) : l.curve = C0(mt.curve, Nf), i.text === void 0 ? i.style !== void 0 && (l.arrowheadStyle = "fill: #333") : (l.arrowheadStyle = "fill: #333", l.labelpos = "c", ka(Xn().flowchart.htmlLabels) ? (l.labelType = "html", l.label = `<span id="L-${o}" class="edgeLabel L-${c2}' L-${d}" style="${l.labelStyle}">${i.text.replace(
      /fa[blrs]?:fa-[\w-]+/g,
...
var me = function(r, e, t, n) {
  ...
  b_(h, I, s.diagramPadding, s.useMaxWidth), Object.keys(g).forEach(function(w) {
    const b2 = g[w];
    if (b2.link) {
...
var Be = {
  ...
  styles: ye,
  init: (r) => {
    r.flowchart || (r.flowchart = {}), r.flowchart.arrowMarkerAbsolute = r.arrowMarkerAbsolute, be2.setConf(r.flowchart), je.clear(), je.setGen("gen-1");
  }
};
export {
  Be as diagram
};
//# sourceMappingURL=flowDiagram-14125c13-FXMVIINZ.js.map
